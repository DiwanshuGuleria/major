...
public class controllerEda {
	// Program Variables
	private EdaStego_View view;
	private EdaStego model;
	...
	public controllerEda(EdaStego_View aView,
			EdaStego aModel) {
		// program variables
		view = aView;
		model = aModel;
	...
	private class Decode implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			chooser.setFileFilter(new Image_FilterEda());
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					String ext = Image_FilterEda.getExtension(directory);
	...
	public static void main(String args[]) {
		new controllerEda(new EdaStego_View("Edge Adaptive Steganography"),
				new EdaStego());
	}
}